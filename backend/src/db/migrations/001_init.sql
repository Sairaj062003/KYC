...
CREATE TABLE IF NOT EXISTS kyc_documents (
  ...
  similarity_category  VARCHAR(20),
...
CREATE INDEX IF NOT EXISTS idx_kyc_risk_cat    ON kyc_documents(similarity_category);
CREATE INDEX IF NOT EXISTS idx_kyc_duplicate   ON kyc_documents(is_duplicate);
